...
import type {
  ChartQuestion as ChartQuestionType,
...
export default function ChartQuestion({
  ...
  onAnswer,
  answered,
}: QuestionComponentProps<ChartQuestionType>) {
    ...
    <div>
      ...
      <div className="mb-4">
        <ChartDisplay
          ...
          xKey={question.chartConfig.xKey}
          yKey={question.chartConfig.yKey}
          yKey2={question.chartConfig.yKey2}
          type={question.chartConfig.type}
          height={question.chartConfig.height}
          yLabel={question.chartConfig.yLabel}
          y2Label={question.chartConfig.y2Label}
        />
      </div>

      {/* Options (same as MultipleChoice) */}
